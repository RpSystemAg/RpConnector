# PR STUDIO BROWSER AGENT — CLAUDE EXECUTION CONSTITUTION
...
must resolve that intent into the real capability and browser execution path and
prove the requested effect end to end. Engineer-only direct calls do not certify
the human-facing route.
