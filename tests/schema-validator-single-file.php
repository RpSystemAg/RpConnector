...
$tests['schema-valued additionalProperties validates dynamic maps']=static function(){ $s=array('type'=>'object','additionalProperties'=>array('type'=>'integer','minimum'=>0));svt(PRSTUDIO_UC_Schema_Validator::validate(array('READY'=>2,'RUNNING'=>1),$s)===array(),'valid typed map rejected');svt(PRSTUDIO_UC_Schema_Validator::validate(array('READY'=>'2'),$s)!==array(),'typed map value bypassed');svt(PRSTUDIO_UC_Schema_Validator::validate(array('READY'=>-1),$s)!==array(),'typed map bound bypassed');};
