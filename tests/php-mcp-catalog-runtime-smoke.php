...
// The consolidated catalogue intentionally contains 119 tools: browser_find is
// already on master and PR #8 adds prstudio_research_radar. Keep the count
// explicit so future inventory changes remain deliberate.
